    ...
    <_Global
      styles={css`
        ...
        body {
          ...
          background:
            radial-gradient(circle at 4% 12%, rgba(255, 255, 255, 0.70) 0 1px, transparent 3px),
            radial-gradient(circle at 8% 18%, rgba(255, 255, 255, 0.50) 0 1px, transparent 3px),
            radial-gradient(circle at 18% 22%, rgba(255, 255, 255, 0.85) 0 1px, transparent 3px),
            radial-gradient(circle at 24% 8%, rgba(255, 255, 255, 0.50) 0 1px, transparent 3px),
            radial-gradient(circle at 31% 12%, rgba(255, 255, 255, 0.70) 0 1px, transparent 3px),
            ...
            radial-gradient(circle at 78% 82%, rgba(255, 255, 255, 0.85) 0 1px, transparent 3px),
            radial-gradient(circle at 93% 91%, rgba(255, 255, 255, 0.70) 0 1px, transparent 3px),
